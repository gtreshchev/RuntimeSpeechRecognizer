...
static const ggml_type_traits_t type_traits[GGML_TYPE_COUNT] = {
    /*[GGML_TYPE_F32] =*/ {
        ...
        /*.is_quantized             =*/ false, NULL, NULL, NULL, NULL,
    ...
    /*[GGML_TYPE_F16] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) ggml_fp32_to_fp16_row, NULL,
    ...
    /*[GGML_TYPE_Q4_0] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q4_0_ref, NULL,
    ...
    /*[GGML_TYPE_Q4_1] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q4_1_ref, NULL,
    ...
    /*[GGML_TYPE_Q5_0] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q5_0_ref, NULL,
    ...
    /*[GGML_TYPE_Q5_1] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q5_1_ref, NULL,
    ...
    /*[GGML_TYPE_Q8_1] =*/ {
        ...
        /*.is_quantized             =*/ true, NULL,
        /*.from_float               =*/ quantize_row_q8_1,
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q8_1_ref, NULL, NULL,
        /*.vec_dot_type             =*/ GGML_TYPE_Q8_1,
        /*.nrows                    =*/ 1,
    },
    /*[GGML_TYPE_Q2_K] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q2_K_ref, NULL,
    ...
    /*[GGML_TYPE_Q3_K] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q3_K_ref, NULL,
    ...
    /*[GGML_TYPE_Q4_K] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q4_K_ref, NULL,
    ...
    /*[GGML_TYPE_Q5_K] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q5_K_ref, NULL,
    ...
    /*[GGML_TYPE_Q6_K] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_q6_K_ref, NULL,
    ...
    /*[GGML_TYPE_Q8_K] = */{
        ...
        /*.is_quantized             =*/ true, NULL,
        /*.from_float               =*/ quantize_row_q8_K, NULL, NULL,
    },
    /*[GGML_TYPE_IQ2_XXS] =*/ {
        /*.type_name                =*/ "iq2_xxs",
        /*.blck_size                =*/ QK_K, 0,
    ...
    /*[GGML_TYPE_IQ3_XXS] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t)quantize_row_iq3_xxs_ref, NULL,
    ...
    /*[GGML_TYPE_IQ4_NL] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t)quantize_row_iq4_nl_ref, NULL,
    ...
    /*[GGML_TYPE_IQ3_S] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t)quantize_row_iq3_s_ref, NULL,
    ...
    /*[GGML_TYPE_IQ2_S] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t)quantize_row_iq2_s_ref, NULL,
    ...
    /*[GGML_TYPE_IQ4_XS] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t)quantize_row_iq4_xs_ref, NULL,
    ...
    /*[GGML_TYPE_F64] = */{
        ...
        /*.is_quantized             =*/ false, NULL, NULL, NULL, NULL, NULL, ggml_type(),
        /*.nrows                    =*/ 1,
    },
    /*[GGML_TYPE_IQ1_M] =*/ {
        /*.type_name                =*/ "iq1_m",
    ...
    /*[GGML_TYPE_BF16] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) ggml_fp32_to_bf16_row_ref, NULL,
    ...
    /*[GGML_TYPE_TQ1_0] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_tq1_0_ref, NULL,
    ...
    /*[GGML_TYPE_TQ2_0] =*/ {
        ...
        /*.from_float_ref           =*/ (ggml_from_float_t) quantize_row_tq2_0_ref, NULL,
...
#define GGML_F16_VEC_LOAD(p, i)     GGML_F32Cx8_LOAD((ggml_fp16_t*)p)
...
static struct ggml_tensor * ggml_add_rel_pos_impl(
    ...
    result->op     = GGML_TYPE_F16_REL_POS;
    result->src[0] = a;
    result->src[1] = pw;
    result->src[2] = ph;
...
static struct hash_map * ggml_new_hash_map(size_t size) {
    ...
    result->set = (ggml_hash_set)ggml_hash_set_new(size);
    result->vals = (ggml_tensor **)GGML_CALLOC(result->set.size, sizeof(struct ggml_tensor *));
    return result;
}
...
static void ggml_compute_backward(struct ggml_context * ctx, struct ggml_tensor * tensor, struct ggml_hash_set * zero_table, struct ggml_hash_set * acc_table) {
    ...
    switch (tensor->op) {
        ...
        case GGML_OP_POOL_2D:
            {
                if (src0->grad) {
                    const enum ggml_op_pool op = (ggml_op_pool)ggml_get_op_params_i32(tensor, 0);
...
struct ggml_cgraph * ggml_new_graph_custom(struct ggml_context * ctx, size_t size, bool grads) {
    ...
    struct ggml_tensor ** nodes_ptr = (ggml_tensor **)incr_ptr_aligned(&p, size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *));
    struct ggml_tensor ** leafs_ptr = (ggml_tensor **)incr_ptr_aligned(&p, size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *));
    struct ggml_tensor ** hash_keys_ptr = (ggml_tensor **)incr_ptr_aligned(&p, hash_size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *));
    struct ggml_tensor ** grads_ptr = grads ? (ggml_tensor **)incr_ptr_aligned(&p, size * sizeof(struct ggml_tensor *), sizeof(struct ggml_tensor *)) : NULL;
...
void ggml_threadpool_params_init(struct ggml_threadpool_params * p, int n_threads) {
    ...
    p->prio       = (ggml_sched_priority)0;     // default priority (usually means normal or inherited)
...
static struct ggml_threadpool * ggml_threadpool_new_impl(
    ...
    struct ggml_threadpool * threadpool =
        (ggml_threadpool *)GGML_ALIGNED_MALLOC(sizeof(struct ggml_threadpool));
    {
    ...
    struct ggml_compute_state * workers = (ggml_compute_state*)GGML_ALIGNED_MALLOC(workers_size);
