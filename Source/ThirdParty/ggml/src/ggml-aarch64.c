...
#endif
static inline __m256 __avx_f32cx8_load_aarch64(ggml_fp16_t *x) {
    float tmp[8];
...
static inline __m256 __avx_repeat_f32cx8_load_aarch64(ggml_fp16_t *x) {
    float tmp[8];
...
static inline __m256 __avx_rearranged_f32cx8_load_aarch64(ggml_fp16_t *x, __m128i arrangeMask) {
    uint16_t tmphalf[8];
    float tmp[8];
...
#define GGML_F32Cx8_LOAD(x)     __avx_f32cx8_load_aarch64(x)
#define GGML_F32Cx8_REPEAT_LOAD(x, loadMask)     __avx_repeat_f32cx8_load_aarch64(x)
#define GGML_F32Cx8_REARRANGE_LOAD(x, arrangeMask)     __avx_rearranged_f32cx8_load_aarch64(x, arrangeMask)
#if defined(__AVX512F__)
