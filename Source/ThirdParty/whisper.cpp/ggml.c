...
static void quantize_row_q4_0(const float * restrict x, void * restrict vy, int k) {
    ...
    block_q4_0 * restrict y = (block_q4_0*)vy;
...
static void quantize_row_q4_1_reference(const float * restrict x, void * restrict vy, int k) {
    ...
    block_q4_1 * restrict y = (block_q4_1*)vy;
...
static void quantize_row_q4_2(const float * restrict x, void * restrict vy, int k) {
    ...
    block_q4_2 * restrict y = (block_q4_2*)vy;
...
static void quantize_row_q5_0(const float * restrict x, void * restrict vy, int k) {
    ...
    block_q5_0 * restrict y = (block_q5_0*)vy;
...
static void quantize_row_q5_1(const float * restrict x, void * restrict vy, int k) {
    ...
    block_q5_1 * restrict y = (block_q5_1*)vy;
...
static void dequantize_row_q4_2(const void * restrict vx, float * restrict y, int k) {
    ...
    const block_q4_2 * restrict x = (block_q4_2*)vx;
...
static const quantize_fns_t quantize_fns[GGML_TYPE_COUNT] = {
    ...
    /*[GGML_TYPE_Q4_0] =*/ {
        dequantize_row_q4_0,
        quantize_row_q4_0,
        (quantize_row_q_t) quantize_row_q4_0_reference,
        quantize_row_q8_0,
    ...
    /*[GGML_TYPE_Q4_1] =*/ {
        dequantize_row_q4_1,
        quantize_row_q4_1,
        (quantize_row_q_t) quantize_row_q4_1_reference,
        quantize_row_q8_1,
    ...
    /*[GGML_TYPE_Q4_2] =*/ {
        dequantize_row_q4_2,
        quantize_row_q4_2,
        (quantize_row_q_t) quantize_row_q4_2_reference,
        quantize_row_q8_0,
        ggml_vec_dot_q4_2_q8_0,
        GGML_TYPE_Q8_0,
    }, {NULL},
    /*[GGML_TYPE_Q5_0] =*/ {
        dequantize_row_q5_0,
        quantize_row_q5_0,
        (quantize_row_q_t) quantize_row_q5_0_reference,
        quantize_row_q8_0,
    ...
    /*[GGML_TYPE_Q5_1] =*/ {
        dequantize_row_q5_1,
        quantize_row_q5_1,
        (quantize_row_q_t) quantize_row_q5_1_reference,
        quantize_row_q8_1,
   ...
   /* [GGML_TYPE_Q8_0] =*/ {
        dequantize_row_q8_0,
        quantize_row_q8_0,
        (quantize_row_q_t) quantize_row_q8_0_reference,
        quantize_row_q8_0,
    ...
    /*[GGML_TYPE_Q8_1] =*/ {
        NULL,   // TODO
        quantize_row_q8_1,
        (quantize_row_q_t) quantize_row_q8_1_reference,
        quantize_row_q8_1,
        NULL,   // TODO
        GGML_TYPE_Q8_1,
    },
...
static const size_t GGML_TYPE_SIZE[GGML_TYPE_COUNT] = {
    ...
    /*[GGML_TYPE_Q4_2] =*/ sizeof(block_q4_2), NULL,
...
void ggml_graph_compute(struct ggml_context * ctx, struct ggml_cgraph * cgraph) {
    ...
    for (int i = 0; i < cgraph->n_nodes; i++) {
        ...
        if (node->n_tasks > 1) {
            ...
            // launch thread pool
            for (int j = 0; j < n_threads - 1; j++) {
                workers[j].params = ggml_compute_params {
                    /*.type  =*/ GGML_TASK_COMPUTE,
                    /*.ith   =*/ j + 1,
                    /*.nth   =*/ node->n_tasks,
                    /*.wsize =*/ cgraph->work ? ggml_nbytes(cgraph->work) : 0,
