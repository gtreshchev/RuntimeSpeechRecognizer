...
static enum ggml_opt_result ggml_opt_adam(
    ...
    float * x  = (float *)opt->adam.x->data;  // view of the parameters
    float * g1 = (float *)opt->adam.g1->data; // gradient
    float * g2 = (float *)opt->adam.g2->data; // gradient squared
    float * m  = (float *)opt->adam.m->data;  // first moment
    float * v  = (float *)opt->adam.v->data;  // second moment
    float * mh = (float *)opt->adam.mh->data; // first moment hat
    float * vh = (float *)opt->adam.vh->data; // second moment hat
        ...
        case GGML_TYPE_Q2_K:
            {
                ...
                block_q2_K * block = dst + start / QK_K;
