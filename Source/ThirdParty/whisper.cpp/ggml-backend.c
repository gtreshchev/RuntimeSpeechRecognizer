...
ggml_backend_sched_t ggml_backend_sched_new(
    ...
    sched->tensor_copies     = (ggml_tensor*(*)[GGML_SCHED_MAX_BACKENDS][GGML_SCHED_MAX_COPIES])(calloc(sizeof(sched->tensor_copies[0]), sched->hash_set.size));

    const size_t nodes_size = graph_size + GGML_SCHED_MAX_SPLITS*GGML_SCHED_MAX_SPLIT_INPUTS*2;
    sched->node_backend_ids  = (int *)calloc(sizeof(sched->node_backend_ids[0]), nodes_size);
    sched->leaf_backend_ids  = (int *)calloc(sizeof(sched->leaf_backend_ids[0]), nodes_size);
    ...
    sched->splits = (ggml_backend_sched_split*)calloc(sizeof(sched->splits[0]), initial_splits_capacity);
